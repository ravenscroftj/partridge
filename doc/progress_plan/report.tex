...
It is proposed that Partridge should use the CoreSC schema for document storage
in order to provide a standard way to access and process the papers and thus
eliminate the task of dealing with multiple documents during its learning
phase. Using CoreSC also offers the advantage of making Partridge compatible
