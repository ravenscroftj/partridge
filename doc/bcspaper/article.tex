...
categories contain too few papers to be useful, others are too specific (e.g.
{\it Message from PLoS}) or appear rather {\it ad hoc}. Indeed it is not clear
how these paper types have been identified. We chose to look at a range of
types, some of which we expect to overlap or have an unclear distinction.
These are namely: Essay, Correspondence, Case Study, Perspective, Viewpoint,
Opinion, Review, Research. 
